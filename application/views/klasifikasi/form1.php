<div class="content">
    ...
    <div class="panel panel-success">
        <div class="panel-heading">
            <h5 class="panel-title">Form <?php echo $button1 ?></h5>
        ...
        <div class="panel-body"> 
            ...
            <div class="form-group">
                      <label for="text">Id Data Training</label>
                      <input type="text" class="form-control" id="id_data_set" name="id_data_set"value="<?php echo $id_data_set;?>">
            </div>
                ...
                <br><br>
                <center>
                    <button type="submit" class="btn btn-success btn-large"><?php echo $button1 ?></button> 
                </center> 
